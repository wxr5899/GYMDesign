...
public class CourseJSONFileProcessor {
    ...
    final static private String LiveCourseFileURL = "SEGroup80/CourseFile/LiveCourseFile.txt";
    final static private String RecCourseFileURL = "SEGroup80/CourseFile/RecCourseFile.txt";
